                    ...
                    <div class="navbar-header">
                        <div class="container-fluid">
                            ...
                            <div>
                                ...
                                <!-- App Search-->
                                <form
                                    class="app-search d-none d-lg-inline-block"
                                >
                                ...
                                <div
                                    class="dropdown dropdown-mega d-none d-lg-inline-block ms-2"
                                >
                                    <button
                                        type="button"
                                        class="btn header-item waves-effect"
                                            ...
                                            <div class="col-sm-6">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <ul
                                                            class="list-unstyled megamenu-list text-muted"
                                                        >
                                                            <li>
                                                                <a
                                                                    href="javascript:void(0);"
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <ul
                                                            class="list-unstyled megamenu-list"
                                                        >
                                                            <li>
                                                                <a
                                                                    href="javascript:void(0);"
                    ...
                    <div class="h-100">
                        <div class="user-wid text-center py-4">
                            ...
                            <div class="mt-3">
                                <a
                                    href="#"
                                    class="text-body fw-medium font-size-16"
                                    >Anik Majumder</a
                                >
